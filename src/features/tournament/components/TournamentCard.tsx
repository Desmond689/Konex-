 ...
 *
 * A card displaying tournament information (feature-scoped copy)
 *
 * Usage:
 * <TournamentCard
...
export const TournamentCard: React.FC<TournamentCardProps> = ({
  ...
  const progress =
    tournament.maxSquads > 0
      ? tournament.registeredSquads / tournament.maxSquads
      : 0;
        ...
        <View style={{ padding: 12 }}>
          ...
          <View style={slotsStyle}>
            <Text style={slotsTextStyle}>
              📋 {tournament.registeredSquads}/{tournament.maxSquads} squads
              registered
          ...
          <View style={footerStyle}>
            ...
            >
              ...
              <Text style={creatorTextStyle}>
                by {tournament.creatorGamerTag}
              </Text>
            </TouchableOpacity>
