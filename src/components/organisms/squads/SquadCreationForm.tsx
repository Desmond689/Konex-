    ...
    <ScrollView style={containerStyle} testID={testID} showsVerticalScrollIndicator={false}>
      ...
      <View style={sectionStyle}>
        ...
        <Dropdown
          ...
          onSelect={(value: any) => setFormData({ ...formData, squadType: value })}
        ...
        <Dropdown
          ...
          onSelect={(value: any) => setFormData({ ...formData, joinType: value as any })}
          containerStyle={{ marginBottom: 12 }}
        />
        ...
        <Dropdown
          ...
          onSelect={(value: any) => setFormData({ ...formData, maxMembers: value })}
          containerStyle={{ marginBottom: 12 }}
        />
      </View>
