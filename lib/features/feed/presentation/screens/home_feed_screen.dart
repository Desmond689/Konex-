...
class _HomeFeedScreenState extends ConsumerState<HomeFeedScreen>
  ...
  Future<void> _openComposer() async {
    final created = await showCreatePostSheet(context, origin: ComposerOrigin.home);
    if (created == true) {
      ref.read(feedControllerProvider.notifier).loadInitial();
    }
  }
      ...
      appBar: AppBar(
        title: Row(
          ...
          children: [
            ...
            Text('KONEX', style: AppTextStyles.brand.copyWith(fontSize: 18, letterSpacing: 1.5)),
          ],
        ),
        actions: [
          IconButton(
      ...
      body: Column(
        children: [
          ...
          _FilterPillsRow(
            ...
            onSelect: (id) => ref.read(feedControllerProvider.notifier).setCommunityFilter(id),
          ),
          _ComposerBar(
            ...
            onVideo: () async {
              ...
              if (created == true) ref.read(feedControllerProvider.notifier).loadInitial();
            },
            onPoll: () async {
              final created = await Navigator.of(context).push<bool>(
        ...
        child: Column(
          ...
          children: [
            InkWell(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text("What's on your mind, $name?", style: AppTextStyles.bodySecondary),
                  ),
                ],
              ),
            ),
            ...
            Row(
              ...
              children: [
                _ComposerAction(icon: Icons.image_outlined, label: 'Photo', onTap: onTap),
                _ComposerAction(icon: Icons.videocam_outlined, label: 'Video', onTap: onVideo),
                _ComposerAction(icon: Icons.poll_outlined, label: 'Poll', onTap: onPoll),
                _ComposerAction(icon: Icons.event_outlined, label: 'Event', onTap: onEvent),
              ],
            ),
          ],
        ),
            ...
            children: [
              Padding(
                ...
                child: FilterChip(
                  ...
                  avatar: selectedId == null ? const Icon(Icons.check, size: 16, color: Colors.white) : null,
                ...
                (g) => Padding(
                  ...
                  child: FilterChip(
                    avatar: g.avatarUrl != null
                        ? CircleAvatar(backgroundImage: CachedNetworkImageProvider(g.avatarUrl!))
...
class _SquadSpotlightCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return InkWell(
      onTap: spotlight != null ? () => context.push('/squad/${spotlight.id}') : null,
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: spotlight?.logoUrl != null
                    ? DecorationImage(image: CachedNetworkImageProvider(spotlight!.logoUrl!), fit: BoxFit.cover)
                    : null,
              ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (spotlight != null) ...[
                    ...
                    Text('Join or create a squad to compete', style: AppTextStyles.caption),
                ],
              ),
            ),
